...
class EditHomestay extends StatefulWidget {
  ...
  @override
  State<EditHomestay> createState() => _EditHomestayState();
}

class _EditHomestayState extends State<EditHomestay> {
  late TextEditingController _nameController;
  late TextEditingController _locationController;
  late TextEditingController _mapLinkController;
  late TextEditingController _activityOneController;
  late TextEditingController _activityTwoController;
  late TextEditingController _activityThreeController;
  ...
  void initState() {
    ...
    _mapLinkController = TextEditingController(text: widget.maplink);
    _activityOneController = TextEditingController(text: widget.activityOne);
    _activityTwoController = TextEditingController(text: widget.activityTwo);
    _activityThreeController =
        TextEditingController(text: widget.activityThree);
    //
...
// for upload
              ...
              TextField(
                controller: _activityOneController,
                keyboardType: TextInputType.emailAddress,
                decoration: const InputDecoration(
                  enabledBorder: OutlineInputBorder(),
                  focusedBorder: OutlineInputBorder(),
              ...
              TextField(
                controller: _activityTwoController,
                keyboardType: TextInputType.emailAddress,
                decoration: const InputDecoration(
                  enabledBorder: OutlineInputBorder(),
                  focusedBorder: OutlineInputBorder(),
              ...
              TextField(
                controller: _activityThreeController,
                keyboardType: TextInputType.emailAddress,
                decoration: const InputDecoration(
                  enabledBorder: OutlineInputBorder(),
                  focusedBorder: OutlineInputBorder(),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    Map<String, dynamic> homestayUpdateInfoMap = {
                      ...
                      "activityOne": _activityOneController.text,
                      "activityTwo": _activityTwoController.text,
                      "activityThree": _activityThreeController.text,
                    };
