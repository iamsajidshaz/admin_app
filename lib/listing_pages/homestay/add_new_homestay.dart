...
class _AddNewHomestayState extends State<AddNewHomestay> {
  ...
  final _activityOneController = TextEditingController();
  final _activityTwoController = TextEditingController();
  final _activityThreeController = TextEditingController();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ===========================
              const Text(
                "Available Facilities (uncheck the one that is not applicable)",
                style: TextStyle(
                  color: Colors.black87,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    if (imageOne != "no" &&
                        ...
                        _activityOneController.text.isNotEmpty &&
                        _activityTwoController.text.isNotEmpty &&
                        _activityThreeController.text.isNotEmpty &&
                        _mapLinkController.text.isNotEmpty) {
                      // upload to db
                      String id =
